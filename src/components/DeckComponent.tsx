  ...
  return (
    <Link to={`/deck/${deck.id}`} state={{ deck }}>
      <div className="group relative cursor-pointer overflow-hidden bg-gray-800 px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:ml-0 sm:mr-auto sm:rounded-lg sm:px-10">
        <span className="absolute top-10 z-0 h-20 w-20 rounded-full bg-slate-600 transition-all duration-300 group-hover:scale-[18]"></span>
        <div className="relative z-10 max-w-md">
          ...
          <div className="space-y-6 pt-5 text-base leading-7 text-slate-300 font-semibold transition-all duration-300 group-hover:text-white/90">
            <p className="font-bold text-slate-300 group-hover:text-white/90">
              {deck.name}
            </p>
